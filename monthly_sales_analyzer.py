...
class MonthlySalesAnalyzer:
    ...
    def parse_report(self, report_file):
        ...
        try:
            ...
            if 'Item Sales Report' in filename or 'Items Sales Report' in filename or 'tem Sales Report' in filename:
                # Extract month and year from filename
                parts = filename.split()
                # For different file naming patterns, the month will be at a different position
                # Check if we have 'Items' or 'Item'
                if parts[0] == 'Items':
                    month = parts[3]  # Month is the 4th part in 'Items Sales Report Month Year'
                    year = parts[4]    # Year is the 5th part
                elif parts[0] == 'Item':
                    month = parts[3]  # Month is the 4th part in 'Item Sales Report Month Year'
                    year = parts[4]    # Year is the 5th part
                elif parts[0] == 'tem':  # Special case for 'tem Sales Report' typo
                    month = parts[3]  # Month is the 4th part
                    year = parts[4]    # Year is the 5th part
                else:
                    # If pattern doesn't match, try a more general approach
                    ...
                    if not month or not year:
                        print(f"Couldn't parse month/year from: {filename}")
                        return None
            else:
